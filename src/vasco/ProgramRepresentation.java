...
public interface ProgramRepresentation<M,N> {
	...
	/**
	 * Returns whether a given node is identity stmt. 
	 * @param node a node in the control-flow graph
	 * @return whether a given node is identity stmt.
	 */
	public boolean isIdentity(N node);
	...
	public Map<M, List<N>> resolveSources(M calleeMethod);
	
	public Map<M, List<N>> initMap();
