...
//	public ForwardInterProceduralAnalysis(M m) {
...
//				A out;
//				
//				//如果node是invokeStmt，则分析inter-procedure
...
//					}
//				} 
//				// 如果node是invokeStmt，则intra-procedure
//				else {
...
//		
//		// Sanity check
//		for (List<Context<M,N,A>> contextList : analyzedContexts.values()) {
...
//		}
//		analyzedContexts.get(method).add(context);
//		
